...
https://github.com/Sadafansari227/techfest-30-build-in-3d

---

## ⚡ Concept & Vision

**TECHFEST // 30** is a futuristic 3D web experience designed as a technological command center representing **Techfest IIT Bombay**, celebrating 30 years of innovation.
...
2. **Interactive 3D Technological Core**:
   - Floating 3D badges (`AI`, `ROBOTICS`, `CYBER`, `INNOVATION`) attached to 3D spatial anchors via `@react-three/drei`.
...
8. **Futuristic HUD UI & Scanlines**:
   - Glassmorphic panels, custom crosshair cursor, mobile navigation drawer, and WebGL error boundary fallback.
...
│   │   └── ScrollProgress.jsx       # Right-hand vertical scroll progress indicator
│   ├── sections/
